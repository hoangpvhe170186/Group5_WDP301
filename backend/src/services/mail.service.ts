import { sendMail } from "../configs/mail.config";

// Hàm tạo template HTML cho OTP
const generateOtpTemplate = (to: string, otpCode: string): string => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
const generateResetPasswordEmail = (to: string, tempPassword: string): string => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
// Gửi mật khẩu reset
const sendResetPasswordEmail = async (to: string, tempPassword: string): Promise<void> => {
